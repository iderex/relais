...
Implemented by issue #45, which is closed. The mechanism that refuses a credential
carrying a claim outside that set is built and lives in
...
reached by it. This paragraph said #45 was not built, in the sentence before the
one saying the mechanism is, which is #178.
